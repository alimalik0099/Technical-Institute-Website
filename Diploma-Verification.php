                ...
                <div class="col-lg-12">
                    <div class="contact-from">
                        ...
                        <div class="main-form pt-45">
                            <form action="verify_diploma.php" method="post" data-toggle="validator">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="singel-form form-group">
                                            <input name="roll_no" type="text" placeholder="Enter Student Roll No" required="">
                                    ...
                                    <div class="col-md-12 text-center mt-2">
                                        <div class="singel-form">
                                            <button type="submit" name="verify_diploma_onsite" class="main-btn">Verify</button>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
