...
$query_chck_email1 = mysqli_query($conn,"SELECT * FROM pending_requests WHERE email = '$email'") or die(mysqli_error($conn)); 
 ...
 $imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
   ...
   move_uploaded_file($_FILES['image']['tmp_name'],$path);
    ...
    VALUES ('$reg_no','$student_name','$father_name','$cnic','$address','$email','$phone','$dob','$class_name','$refer_by','$reference_input','$entry_date','$duration','$image','Online')";
                        ...
                        <div class="page-banner-cont">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Apply for online classes</li>
                                </ol>
                            </nav>
