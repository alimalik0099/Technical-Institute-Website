<?php
session_start();
if(!isset($_SESSION['reg_no']['reg_no'])){
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="support-button float-right d-none d-md-block">
                                ...
                                <div class="button float-left">
                                    <a href="https://student.cmitcomputercollege.tech/" class="main-btn">Student Login</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- row -->
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Apply Successfull</li>
                            </ol>
                        </nav>
                ...
                <div class="col-lg-12">
                    <div class="contact-from">
                        <div class="section-title">
                            ...
                            <h5 class="mt-4">Your application has been sent sucessfully. Please wait for response. We will take few days for your registration review process.<br><br>Now you can Login with your Registration No (<?php echo $reg_no;?>) and your current password is  Cmittalagang.<br><br>Registration/Roll No: <?php echo $reg_no;?><br><br>Login Password: Cmittalagang</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="singel-form text-center">
                                            <a href="https://student.cmitcomputercollege.tech/"><button type="button" name="submit" class="main-btn">Student Login</button></a>
                                        </div> <!-- singel form -->
                                    </div> 
                                </div> <!-- row -->
                            </form>
