            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>CMIT Computer & Technical College Tour</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Events</a></li>
                               <li class="breadcrumb-item active" aria-current="page">CMIT Computer & Technical College Tour</li>
                            </ol>
                        </nav>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="events-left">
                            <h3>CMIT Computer & Technical College Tour</h3>
                            <a href="#"><span><i class="fa fa-calendar"></i> 06 January 2018</span></a>
                            <a href="#"><span><i class="fa fa-clock-o"></i> 09:00 Am - 08:00 Pm</span></a>
                            <a href="#"><span><i class="fa fa-map-marker"></i> Kallar Kahar & Khewra Salt Mines</span></a>
                            <img src="images/event/singel-event/CMIT Computer and technical College Talagang tour.jpg" alt="Event">
                            <p>The CMIT Computer and Technical College organized a trip to Khewra Salt Mines and Kallar Kahar for all classes students on 06 January 2018.<br><br>
                            It was the first trip to CMIT Computer and Technical College so everyone, including the faculty, was ecstatic. The foggy day started with a low temperature, but as the day progressed rays of sunshine finally took over. The first destination was the salt mines, approximately a 1-hour drive from Talagang. Then the students and faculty went to the Kallar Kahar resort, which was a 30-minute ride from there.<br><br>
                            The Khewra Salt Mines, a major tourist attraction, is Pakistan’s largest and oldest salt mines and the world’s second-largest. A tour guide had arranged a visit to the salt mines on an electronic train. Everybody thoroughly enjoyed the bumpy ride. The mines comprise water caves and monuments of Minar-e-Pakistan and Badshahi Masjid made out of salt. Students bought souvenirs such as salt lamps and decoration pieces made out of salt.<br><br>
                            After spending a few hours at the mines, they went to the Kallar Kahar resort. Students enjoyed their mini picnic and the thrilling rides. Refreshments were provided to the students at regular intervals to keep their energy levels up.</p>
                        </div> <!-- events left -->
                    </div>
                    <div class="col-lg-4">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="singel-address">
                                            ...
                                            <div class="cont">
                                                <h6>Address</h6>
                                                <span>Kallar Kahar & Khewra Salt Mines</span>
                                            </div>
                                        </div> <!-- singel address -->
                                    </li>
                                </ul>
