                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                               ...
                               <li class="breadcrumb-item active" aria-current="page">Cricket Tournament</li>
                            </ol>
                        </nav>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="events-left">
                            ...
                            <a href="#"><span><i class="fa fa-calendar"></i> 20 July 2018</span></a>
                            <a href="#"><span><i class="fa fa-clock-o"></i> 08:00 Am - 05:00 Pm</span></a>
                            <a href="#"><span><i class="fa fa-map-marker"></i> Talagang</span></a>
                            <img src="images/event/singel-event/Cricket Matches in CMIT College Talagang.jpg" alt="Event">
                            <p>1.  CMIT Cricket tournament is organized at  
                            Main ground Talagang, and the following teams participated on the first day, 20 Jul, 2018 in tournament:<br><br>

1.  Graphic Designing Team CMIT<br>
2.  Autocad Team CMIT<br>
3.  MS office Team CMIT<br>
4.  Web Development Team CMIT<br><br>

2.  First Match was played between Graphic Designing Team CMIT and MS office Team CMIT, Graphic Designing won the Match.  Second Match was played
between Web Development Team CMIT and Autocad Team CMIT, and the Match was won by Autocad team.
Third Match was played between Graphic Designing team and Autocad team,
Graphic Designing team won the Match.
<br><br> 
The Final was played between Graphic Designing team and Autocad team. The match was very exciting and both the teams exerted their utmost to win the match, some strokes were highly appreciated by the spectators. Graphic Designing team CMIT Talagang won the FINAL. There was a Cash Prize of Rs. 10, 000/- for the WINNER and Rs. 5, 000/- for the RUNNER-UP teams.</p>
                        </div> <!-- events left -->
                    </div>
                    <div class="col-lg-4">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="singel-address">
                                            ...
                                            <div class="cont">
                                                <h6>Address</h6>
                                                <span>CMIT Computer & Technical College Talagang</span>
                                            </div>
                                        </div> <!-- singel address -->
                                    </li>
                                </ul>
