...
if(isset($_POST['submit'])){
  ...
  $entry_date=date('h:i:s a m/d/Y');
      ...
      $sql = "INSERT INTO web_contact(name,email,subject,phone,message,time)
    VALUES ('$name','$email','$subject','$phone','$messege','$entry_date')";
    if (mysqli_query($conn, $sql)) {
        ?>
      <script type="text/javascript">
        alert('Your message has been sent successfully to site owner.');
...
<body>
                        ...
                        <ul>
                            <li>
                                <div class="singel-address">
                                    ...
                                    <div class="cont">
                                        <p>Mundial Chowk, Main Chakwal Road Talagang, District Chakwal, Punjab Pakistan</p>
                                    </div>
                                </div> <!-- singel address -->
                            </li>
                            <li>
 ...
 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3348.887062992576!2d72.41755291433066!3d32.92758198092674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3920948f6aa21d51%3A0x2be1d5d563368df4!2sCMIT!5e0!3m2!1sen!2s!4v1629477150976!5m2!1sen!2s" width="100%" style="border:0;" height="400" allowfullscreen="" loading="lazy"></iframe>
    </section>
    <!--====== CONTACT PART ENDS ======-->
